# Laporan eksekusi pembersihan run training tidak selesai / non-final

Status: **sudah dieksekusi** sesuai persetujuan user.

## Ringkasan eksekusi

- Folder kandidat terhapus: **51**
- Estimasi ruang dibersihkan: **5.6 GB**
- File yang sebelumnya tracked Git dan ikut dihapus dari worktree: **364**
- Folder final 9 model: **tetap ada dan sudah diverifikasi**
- `Report_paper_9model*`: **tidak disentuh**
...
```bash
python3 -m py_compile report_paper_9model_metadata.py aggregate_paper_test_results.py tools_generate_report_paper_9model.py tools_package_report_model_artifacts.py tools_verify_report_model_artifacts.py tools_verify_report_readability.py
python3 tools_verify_report_model_artifacts.py
python3 tools_verify_report_readability.py
# custom check: 9 final run_dir + best_artifact tetap ada
```

## Folder final yang tetap disimpan
...
- `training_conventional/m08_hmm_gmm/runs/run_paper_20260530`
- `training_conventional/m09_dnn_hmm/runs/run_paper_20260530_133634`
- `training_conventional/m10_gmm_hmm_dnn/runs/run_paper_20260531_071736`
- `training_conventional/m11_vanilla_transformer/runs/run_full_20260529_042328`
- `training_conventional/m12_vit_modified/runs/run_full_20260528_223323`
- `training_conventional/m13_wav2letter_cnn/runs/run_paper_20260531_230637`

## Terhapus per model

| Model | Folder terhapus | Est. ruang |
|---|---:|---:|
...
- Pembersihan ini hanya untuk folder run yang terindikasi smoke/debug/test, tidak selesai, atau tidak memiliki evidence final (`checkpoint/report/test_paper`) sesuai audit konservatif.
- Completed old non-final yang tampak selesai/berisi checkpoint besar **tidak ikut dihapus** karena di luar kriteria “training tidak selesai”.
