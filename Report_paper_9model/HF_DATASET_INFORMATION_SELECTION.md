...
| `Report_paper_9model/hf_dataset_information_public/synthetic_data_stats_public.json` | `paper/dataset_information/synthetic_data_stats_public.json` | Full-scope synthetic-data summary with public labels. |
| `Report_paper_9model/hf_dataset_information_public/audio_quality_sample_public.csv` | `paper/dataset_information/audio_quality_sample_public.csv` | Public-safe audio-quality sample; explicitly marked as paper-clean sample scope. |
