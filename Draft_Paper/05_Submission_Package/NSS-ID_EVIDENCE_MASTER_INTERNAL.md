...
**Role of this file:** comprehensive evidence master; the canonical v.19 template-aligned source is [`06_DATA_IN_BRIEF_TEMPLATE_MANUSCRIPT.md`](../04_Revised_Draft/06_DATA_IN_BRIEF_TEMPLATE_MANUSCRIPT.md)  
...
The editable source is [`tables/Specifications_Table.csv`](../04_Revised_Draft/tables/Specifications_Table.csv).
...
Self-contained captions, source/scope notes, conditional-use notes, and the split-hour rounding note for all editable tables are provided in [`05_TABLE_CAPTIONS_AND_NOTES.md`](../04_Revised_Draft/05_TABLE_CAPTIONS_AND_NOTES.md). The machine-readable table values remain in `tables/*.csv`.
