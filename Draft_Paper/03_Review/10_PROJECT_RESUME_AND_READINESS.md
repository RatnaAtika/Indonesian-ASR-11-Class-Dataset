...
Mechanical audit evidence is recorded in [`Draft_Paper/03_Review/11_INTERNAL_PACKAGE_VERIFICATION_REPORT.md`](11_INTERNAL_PACKAGE_VERIFICATION_REPORT.md) and `.json`. `PASS_INTERNAL_ONLY` must not be interpreted as permission to submit or release.
