...
class RevisedManuscriptTableTests(unittest.TestCase):
    ...
    def test_scope_bridge_keeps_release_target_and_benchmark_separate(self) -> None:
        ...
        self.assertEqual("209", rows["Canonical balanced sentence slots"]["release_target"])
        self.assertEqual("209", rows["Canonical balanced sentence slots"]["frozen_benchmark"])
