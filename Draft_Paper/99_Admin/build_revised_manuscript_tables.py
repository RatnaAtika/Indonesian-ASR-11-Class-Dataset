...
def build_table_1(output_dir: Path, evidence: dict, remote_files: list[dict]) -> None:
    ...
    rows = [
        ...
        },
        {
            ...
            "format": "UTF-8 text",
            "rows_or_files": "11 files / 209 canonical balanced sentence slots",
...
def build_table_2(output_dir: Path, evidence: dict) -> None:
    ...
    rows = [
        ...
        {"field": "Canonical balanced sentence slots", "release_target": release["canonical_balanced_sentence_slots"], "frozen_benchmark": 209, "evidence_control": "11 categories × 19 retained slots; original IDs and replacement provenance remain preserved separately"},
...
def build_table_3(output_dir: Path, evidence: dict) -> None:
        ...
        rows.append(
            {
                ...
                "canonical_balanced_sentence_slots": 19,
    ...
    write_csv(
        ...
        [
            ...
            "mean_duration_sec",
            "synthetic_files",
            "canonical_balanced_sentence_slots",
            "sentence_id_note",
            "scope",
        ],
        rows,
